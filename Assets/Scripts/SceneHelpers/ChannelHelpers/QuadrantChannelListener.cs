...
{
    public class QuadrantChannelListener : MonoBehaviour 
    {
        #region Variables ==============================================
        [SerializeField] private QuadrantChannel channelToListenTo;

        public QuadrantEvent onChannelRaised;

        public bool checkLastValueOnStart;
        public bool shouldFilterValue = false;
        public bool shouldPassHeardDataThrough = true;

        public Quadrant filter;
        public Quadrant outgoingDataIfNotPassHeardDataThrough;
        #endregion
        ...
        public void OnHearChannel(Quadrant data)
        {
        ...
        public void SendOutResponse(Quadrant incomingData)
        {
