...
public class RandomLevelDataGenerator : EditorWindow
{
    ...
    private void GenerateRandomLevelData()
    {
        ...
        string assetPath = $"Assets/GeneratedLevels/{levelName}.asset";
        Directory.CreateDirectory("Assets/GeneratedLevels");
        AssetDatabase.CreateAsset(levelDataSO, assetPath);
        AssetDatabase.SaveAssets();
        Debug.Log($"Generated random level data and saved to {assetPath}");
    }
}